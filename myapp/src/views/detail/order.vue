    ...
    <div>
        <div class="order-box">
            <div class="menu-box" ref="menuBox">
                <ul>
                    <li v-for="(item,index) in productList" :key="index" class="menu-list" :class="{'active':currentIndex == index}"
                        ...
                        <ul>
                            <li class="prod-list" v-for="(prod,index) in item.content" :key="prod.id">
                                ...
                                <div class="prod-info">
                                    ...
                                    <div class="sale">
                                        <span class="num">Sold:{{prod.num}}</span>
                                        <span>Good:{{prod.up}}</span>
                                    </div>
    ...
    export default {
        ...
        methods:{
            initScroll(){
                ...
                //Get the vertical position of the elements in the right block
                this.getPosY();
                //Get li list on the left block
